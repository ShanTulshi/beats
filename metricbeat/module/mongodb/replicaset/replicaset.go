...
var debugf = logp.MakeDebug("mongodb.replicaset")

func init() {
	if err := mb.Registry.AddMetricSet("mongodb", "replicaset", New, mongodb.ParseURL); err != nil {
		panic(err)
	}
}
...
func (m *MetricSet) Fetch() (common.MapStr, error) {
	...
	if err := m.mongoSession.DB("admin").Run(bson.D{{Name: "replSetGetStatus", Value: 1}}, &result); err != nil {
		return nil, err
	}
